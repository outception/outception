...
# Home dir, not /var/tmp: a world-writable directory lets any local user
# pre-create or symlink the state file (alert suppression / write redirect).
STATE="${HEALTH_STATE_FILE:-$HOME/.outception-health.state}"
