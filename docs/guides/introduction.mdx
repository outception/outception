---
title: "Guides"
description: "Step-by-step walkthroughs for implementing common Outception patterns."
---
...
Looking to wire Outception into a specific stack? See the [Next.js](/guides/nextjs), [Laravel](/guides/laravel), and [Encore](/guides/encore) guides under **Integrate**.

## Requesting a new guide

Missing something? [Open an issue on outception/outception](https://github.com/outception/outception/issues/new/choose) and tell us what you're trying to build.
