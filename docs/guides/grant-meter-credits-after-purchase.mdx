...
There are two ways to grant initial meter credits in Outception:
...
<Steps>
  <Step title="Create a product">
    Open [**Products → New Product**](https://outception.com/to/dashboard/products/new) in the dashboard.
  </Step>
...
- A Outception account with an organization
- A meter created with **Sum** aggregation
- A product with the meter attached
- Webhooks enabled
- A Outception access token for API calls
...
<Steps>
  <Step title="Use the sandbox environment">
    Test your integration in Outception's [sandbox environment](/integrate/sandbox) to avoid affecting production data.
  </Step>
