---
title: "Integrate Outception with Next.js"
sidebarTitle: "Next.js"
description: "In this guide, we'll show you how to integrate Outception with Next.js."
---
...
[A complete code-example of this guide can be found on GitHub](https://github.com/outception/outception-next).

## Install the Outception JavaScript SDK

To get started, you need to install the Outception JavaScript SDK and the Outception Nextjs helper package. You can do this by running the following command:
...
### Outception Access Token

To authenticate with Outception, you need to create an access token, and supply it to Next.js using a `POLAR_ACCESS_TOKEN` environment variable.

You can create an organization access token from your organization settings.

## Configuring a Outception API Client

To interact with the Outception API, you need to create a new instance of the `Polar` class. This class uses the provided access token to authenticate with the Outception API.
...
Outception can send you events about various things happening in your organization. This is very useful for keeping your database in sync with Outception checkouts, orders, subscriptions, etc.
...
1. Point the Webhook to `your-app.com/api/webhook/polar`. This must be an absolute URL which Outception can reach. If you use ngrok, the URL will look something like this: `https://<your-ngrok-id>.ngrok-free.app/api/webhook/polar`.
