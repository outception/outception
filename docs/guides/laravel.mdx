---
title: "Integrate Outception with Laravel"
sidebarTitle: "Laravel"
description: "In this guide, we'll show you how to integrate Outception with Laravel."
---
...
Outception Laravel Example App
--------------------------------

We've created a simple example Laravel application that you can use as a reference.

[View Code on GitHub](https://github.com/outception/outception-laravel)
...
To authenticate with Outception, you need to create an access token, and supply it to Laravel using a `POLAR_API_KEY` environment variable.

You can create an organization access token from your organization settings.

Fetching Outception Products for display
------------------------------------------
...
This endpoint will be responsible for creating a new checkout session, redirecting the user to the Outception Checkout page & redirect back to a configured confirmation page.
...
* OutceptionSignature.php
* ProcessWebhook.php

Inside app/Handler/OutceptionSignature.php, what we want to do is to validate that the request came from Outception. Add the code to that file.
