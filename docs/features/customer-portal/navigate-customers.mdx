...
There are three ways your customers can land on the Customer Portal: the default URL, a pre-authenticated link you generate from your application, or the links Outception automatically includes in the emails it sends to your customers.
...
Customers authenticate by entering the email address they used to purchase or subscribe. Outception then emails them a one-time code to complete sign-in.
...
## 3. Emails Outception sends to your customers

You don't have to build anything to get customers to the portal — Outception already includes a link to it in the transactional emails we send on your behalf, including:
