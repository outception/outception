...
Want to help us review translations for an upcoming language? Reach out at [translations@outception.com](mailto:translations@outception.com).
...
- Open an issue on [GitHub](https://github.com/outception/outception)
- Email us at [translations@outception.com](mailto:translations@outception.com)
