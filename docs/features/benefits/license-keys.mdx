...
You can easily sell software license keys with Outception without having to deal with sales tax or hosting an API to validate them in real-time. License keys with Outception come with a lot of powerful features built-in.
...
1. Go to [`Benefits`](https://outception.com/to/dashboard/products/benefits)
...
**Enable user to deactivate instances via Outception.** Instead of building your own custom admin for customers to manage their activation instances - leave it to Outception instead.
...
It's super easy and straightforward to integrate Outception license keys into your application, library or API.
