...
Outception offers built-in benefit (entitlements) automation for common upsells within the developer &
...
- [**Shared Slack Channel**](/features/benefits/slack-shared-channel). Give customers a shared Slack channel via Slack Connect.

## Product & Subscription Benefits

Product and subscription benefits are standalone resources in Outception - connected to one or many products or subscription tiers.
