---
title: "Affonso Affiliates with Outception"
sidebarTitle: "Affonso (Affiliates)"
---

This guide explains how to integrate
[Affonso](https://affonso.io)'s affiliate marketing software with your Outception
...
### 1. Create a Outception Access Token for Affonso

First, you'll need to create an API token in Outception that Affonso can use to communicate with your account:

1. Login to your **Outception Dashboard**
2. Navigate to [**Settings**](https://outception.com/to/dashboard/settings)
...
<video controls width="600">
  <source
  src="https://affonso-videos.s3.eu-central-1.amazonaws.com/Connect_Outception_Affonso_1.mp4"
  type="video/mp4" />
</video>


### 2. Set Up Webhooks in Outception

After connecting your Outception account with Affonso, you'll [receive a webhook URL and secret from Affonso](https://affonso.io/app/affiliate-program/connect). Add these to your Outception account:

1. Go to [**Settings → Webhooks**](https://outception.com/to/dashboard/settings/webhooks) in your Outception Dashboard
...
<video controls width="600">
  <source
  src="https://affonso-videos.s3.eu-central-1.amazonaws.com/Connect_Outception_Affonso_2.mp4"
  type="video/mp4" />
</video>
...
### 5. Pass Referral Data to Outception Checkout
...
3. When the user makes a purchase, the referral ID is passed to Outception as metadata
4. Outception's webhook notifies Affonso about the purchase
...
More details about the integration: [Outception Affiliate Program](https://affonso.io/outception-affiliate-program)
