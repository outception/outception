...
Our Python SDK includes an ingestion helper and strategies for common use cases. It's installed as part of the Outception SDK.
...
The ingestion helper is a simple wrapper around the Outception events ingestion API. It takes care of batching and sending events to Outception in the background, without blocking your main thread.
...
With our PydanticAI strategy, you can easily track the usage of LLMs and send the data to Outception for billing.
