...
Outception offers an ingestion framework to work with Outception's event ingestion API.
...
We're always looking for ways to improve our ingestion strategies. Feel free to contribute — [Outception Ingestion SDK](https://github.com/outception/outception-ingestion).
