As a Merchant of Record (MoR), Outception resells your digital goods and services on your behalf. To do this responsibly, we verify that every business using Outception complies with our [Acceptable Use Policy](/merchant-of-record/acceptable-use), and we continuously monitor transactions to prevent fraud, abuse, and high-risk activity.
...
Before your first payout, you'll go through our main account review. You can submit everything yourself from [**Finance → Account**](https://outception.com/to/dashboard/finance/account) in your Outception dashboard, in three steps:

1. **Submit for approval.** Tell us about your business, your products, and how you intend to use Outception.
...
When an account violates our [Acceptable Use Policy](/merchant-of-record/acceptable-use) — separately from chargeback issues — we offboard the merchant. Payment processing is blocked and payouts are held pending review.
...
<AccordionGroup>
  ...
  <Accordion title="How do I transfer my organization to a new admin?">
    ...
    1. Invite the new admin to the team via `Settings` > `Members` in the Outception dashboard
    2. Ask that new admin to complete identity verification under `Finance` > `Account` after logging in via that email in the Outception dashboard
    ...
    If you need assistance with changing organization ownership or have special circumstances, please contact [support@outception.com](mailto:support@outception.com).
  </Accordion>
</AccordionGroup>
