...
- **Production**: `https://mcp.polar.sh/mcp/polar-mcp` - Connect to your live Outception organization
- **Sandbox**: `https://mcp.polar.sh/mcp/polar-sandbox` - Connect to the Outception sandbox environment for testing
...
Name it "Outception" and add `https://mcp.polar.sh/mcp/polar-mcp` as the server URL.
