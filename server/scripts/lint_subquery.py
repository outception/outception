...
- Variable-rooted chains (`statement.subquery()`) are NOT flagged — we can't
  statically determine the root. Those cases rely on the documented project
  convention and code review. If you introduce a new variable-rooted `.subquery()` on an
