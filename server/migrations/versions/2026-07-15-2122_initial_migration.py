...
def upgrade() -> None:
    ...
    op.create_entity(public_uuid_ossp)  # type: ignore[attr-defined]

    public_citext = PGExtension(schema="public", signature="citext")
    op.create_entity(public_citext)  # type: ignore[attr-defined]
...
def downgrade() -> None:
    ...
    public_citext = PGExtension(schema="public", signature="citext")
    op.drop_entity(public_citext)  # type: ignore[attr-defined]

    public_uuid_ossp = PGExtension(schema="public", signature="uuid-ossp")
    op.drop_entity(public_uuid_ossp)  # type: ignore[attr-defined]
