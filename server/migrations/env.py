...
def render_item(type_, obj, autogen_context):
    # StringEnum is a plain VARCHAR at the database level; render it as
    # sa.String so generated migrations never import the app's custom type
    # (the emitted DDL is identical either way).
