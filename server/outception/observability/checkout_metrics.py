...
Metrics:
- outception_checkout_created_total: Counter of checkouts created
- outception_checkout_succeeded_total: Counter of successful checkouts
"""
...
CHECKOUT_CREATED_TOTAL = Counter(
    "outception_checkout_created_total",
    "Total number of checkouts created",
)

CHECKOUT_SUCCEEDED_TOTAL = Counter(
    "outception_checkout_succeeded_total",
