...
TASK_EXECUTIONS = Counter(
    "outception_task_executions_total",
    "Total number of task executions",
    ["queue", "task_name", "status"],
)

TASK_DURATION = Histogram(
    "outception_task_duration_seconds",
...
TASK_DEBOUNCED = Counter(
    "outception_task_debounced_total",
    "Total number of debounced tasks",
    ["queue", "task_name"],
)

TASK_DEBOUNCE_DELAY = Histogram(
    "outception_task_debounce_delay_seconds",
