...
class Settings(BaseSettings):
    ...
    # right for the background summary warmer, which is where it frees Gemini
    # and Groq for readers.
    ...
    # Free-tier calls per minute for summaries (the tier allows 15; headroom
    # keeps a burst from tripping a 429 that would bench Gemini and push
    # readers onto the paid path).
