...
from outception.cli import auth
from outception.cli.listener import mark_active, mark_inactive
from outception.eventstream.endpoints import subscribe
from outception.eventstream.service import Receivers
...
from outception.organization.service import organization as organization_service
        ...
        try:
            ...
            if event.get("key") == "webhook.created":
                ...
                if webhook_payload and webhook_event_id:
                    ...
                    event["headers"] = {
                        "user-agent": "outception.com webhooks",
