...
class Logging[RendererType]:
    """Outception logging configurator of `structlog` and `logging`.

    Renders stdlib logging through structlog-based formatters (see
    structlog's standard-library integration guide).
    """
...
class CorrelationID:
    _correlation_id: typing.ClassVar[contextvars.ContextVar[str | None]] = (
        contextvars.ContextVar("outception.correlation_id", default=None)
    )
