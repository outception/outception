...
_BASE_RULES: dict[str, Sequence[Rule]] = {
    ...
    # /batch fans out across up to 256 sources per request and /{source_id} can
    # drive a live upstream fetch, so both belong in the tight zone rather than
    # the 500/min catch-all.
    "^/v1/news/(weather|translate|search|batch)": [
