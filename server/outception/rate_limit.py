...
_BASE_RULES: dict[str, Sequence[Rule]] = {
    ...
    "^/v1/news/(weather|search|batch|heatmap)": [
    ...
    # One request per source per poll, so a reader with a full card set open makes
    ...
    # single-segment news route (/sources, /default-cards, /templates,
