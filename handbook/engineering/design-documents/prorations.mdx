...
| **Monthly to yearly** |  | Would be a switch of products in Outception |  | Would be a switch of products in Outception |
| **Yearly to monthly** | Sets billing anchor to “now” (when the downgrade happened) and starts the monthly subscription from then

+ adds remaining amount to customer balance | Would be a switch of products in Outception |  | Would be a switch of products in Outception |
...
Use existing `BillingEntry` data model as described in [outception#6118](https://github.com/outception/outception/issues/6118).
...
- Data
    ...
    ```json
    {
      ...
      "footer": "Outception registrations\n\nIrish OSS VAT: EU372061545",
      "forgiven": false,
      "from_invoice": null,
      "frozen": true,
      ...
      "rendering": {
        ...
        "fields": {
          ...
          "footer": {
            ...
            "value": "Outception registrations\n\nIrish OSS VAT: EU372061545"
          }
        },
        "pdf": null,
        "template": null,
