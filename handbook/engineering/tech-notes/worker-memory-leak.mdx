---
title: "Investigating Worker Memory Leak in Outception"
...
I'm trying to find the memory leak in the outception source code for Worker. The main stack is Python 3.12, Dramatiq with Redis as a Broker.
