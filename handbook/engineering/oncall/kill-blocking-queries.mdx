...
- [ ] Document in the [on-call log](/engineering/on-call-log)
- [ ] Notify the team
...
See also the [on-call log](/engineering/on-call-log) entry for the 2026-06-02 incident for a worked example.
