...
export const PrivacyContent = () => (
  <Box gap="spacing-16" paddingBottom="spacing-16">
    ...
    <Section title="Advertising">
      <P>
        Outception is free and supported by ads. We use Google AdMob in our
        mobile apps and Google AdSense on the website. These Google services may
        use cookies and device advertising identifiers to serve and measure ads,
        including personalized ads where you have consented.
      </P>
      <Bullet>
        In the EU/UK, we show a consent prompt before personalized ads are
      ...
      <Bullet>
        You can control Google’s use of advertising data at
    ...
    <Section title="Why we process your data">
      <Bullet>
        <B>Consent</B> — for personalized advertising, analytics, and precise
        location.
      </Bullet>
      <Bullet>
        <B>Legitimate interests</B> — to keep the service secure, functional,
        and free (including non-personalized ads).
      </Bullet>
    </Section>
    ...
    <Section title="Sharing your data">
      <P>
        ...
        (advertising), PostHog, and Sentry — each acting under contract. When
        you tap a headline you leave Outception for the publisher’s own site,
        which has its own privacy practices we don’t control.
      </P>
    </Section>
