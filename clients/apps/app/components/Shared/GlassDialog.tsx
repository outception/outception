...
export const GlassDialog = ({
  ...
  return (
    <Box style={[StyleSheet.absoluteFill, { zIndex: 40 }]}>
      {/* Scrim: always-BLACK dim (never the text color - when text went
          pure white for dark mode, a text-colored scrim laid a white veil
          over the wall and brightened it instead of dimming). The wall
          behind stays itself, one gentle step darker, like the web. */}
