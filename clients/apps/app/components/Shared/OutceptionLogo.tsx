...
// Outception sparkle mark — matches the web LogoIcon / favicon exactly: a crisp
// star silhouette clip painted with a red radial dome, a darker underside tail,
// and two thin "equator" seams. The mark is a fixed-colour gradient, so it does
// not tint with the theme.
const STAR_PATH =
