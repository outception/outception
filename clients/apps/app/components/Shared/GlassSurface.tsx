      ...
      <View
        ...
        style={[
          StyleSheet.absoluteFill,
          {
            ...
            // iOS: well below the web's 60/72% — the BlurView tint already
            // whitens/darkens the pane, so these land at the web's PERCEIVED
            // translucency. Android: no blur underneath, so the wash alone
            // must keep pane text legible over the un-blurred wall.
            opacity:
              Platform.OS === 'ios'
                ? tone === 'dark'
                  ? 0.45
