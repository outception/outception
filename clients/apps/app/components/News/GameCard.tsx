 ...
 * card set pairs this with the type check and falls back to the news card. */
 ...
 * web MiniGameCard → GameNoteBar. The card set's swipe gesture is restricted to
 * the header for game cards (see SwipeCard) - touches on the board belong
...
export const GameCard = memo(function GameCard({
  ...
  const onGameMessage = (e: WebViewMessageEvent) => {
    ...
    // A stroke on the game's non-interactive chrome: the card set's own pan is
