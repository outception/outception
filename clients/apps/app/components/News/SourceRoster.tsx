 ...
 * topic, and star sources into your cards without needing to type. Rendered
...
export const SourceRoster = ({
  ...
  /** See SourceSearchSheet: the first-launch welcome opens with the keyboard
   * down so the Starter card sets get the full screen. */
  ...
  // Starter card sets are the default view, matching the web dialog - except when
    ...
    >
      ...
      <Touchable
        onPress={() => {
          ...
          unfollowAll(ids)
          // On the unfiltered view this empties the whole card set, so the
      ...
      <Box style={{ zIndex: 1 }}>
        ...
        >
          ...
          <Input
            ...
            // Starters gallery shows first (see templatesOpen above). The
            // one exception is the first-launch welcome, where the keyboard
            // would bury the Starter card sets it exists to show.
