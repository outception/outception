 ...
 * timezone. Used to seed the country-tailored default card set and to pick the
...
/** The device's region (e.g. "IE"), used to tailor the default card set. This is
 ...
 * weather in Washington and shown a US card set. */
