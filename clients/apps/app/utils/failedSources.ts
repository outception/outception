/**
 * Sources whose feed keeps failing - dropped from the card set so dead cards never
 ...
 * no way back - and if it was the card being read, the card set shifted underneath
 * the reader.
 */
