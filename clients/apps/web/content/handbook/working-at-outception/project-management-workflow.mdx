...
| `outception-team`            | Reserved for our internal team                                           |
...
| --------------------- | -------------- | ----------------------------------------------------------------------------------------------------------  |
| **outception**             | 🟢 Public      | Default to public for all our features, tasks and bugs                                                      |
| **outception-internal**    | 🔒 Private     | Internal tasks we need to keep private, e.g customer-specific data, internal ops or surprise launches       |
| **outception-adapters**    | 🟢 Public      | *Redirected/submitted to `outception`*                                                                           |

Making it easy to coordinate our efforts in public with some exceptions in `outception-internal` only available to the team.
...
**Actions:**
- If it's a support request: ask the user to write to support@outception.com and close the issue.
