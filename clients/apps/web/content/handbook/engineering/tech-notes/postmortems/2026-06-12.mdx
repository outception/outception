---
title: "2026-06-12"
description: "An incident report detailing the outage of the Outception platform on June 12, 2026, its impact, root cause analysis, and actions taken to prevent future occurrences."
---

<Note>
  Historical record. The **sandbox** environment referenced in this report has
  since been decommissioned; sandbox and production no longer share a database
  instance. The timeline below is preserved as written at the time of the incident.
</Note>

## Summary

On Jun 12, 2026 at 13:17 UTC, the Outception platform was down for an hour.
...
- The Outception dashboard, API, and checkout infrastructure were unavailable.
...
- **13:17:46**: Outception fully down. **Incident starts**
...
- **14:18:00**: Outception confirmed to be up but with degraded performance on metrics endpoints
