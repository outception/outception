...
import { List, ListItem } from '@outception-com/orbit/List'
      ...
      <form method="post" action={actionURL}>
        ...
        {hasTerms && (
          <div className="mt-8 text-center text-sm text-gray-500">
            ...
            {safeExternalHref(client.tos_uri) && (
              <a
                className="dark:text-outception-300 text-gray-700"
                href={safeExternalHref(client.tos_uri)}
              >
                Terms of Service
              </a>
            )}
            {safeExternalHref(client.tos_uri) &&
              safeExternalHref(client.policy_uri) &&
              ' and '}
            {safeExternalHref(client.policy_uri) && (
              <a
                className="dark:text-outception-300 text-gray-700"
                href={safeExternalHref(client.policy_uri)}
              >
                Privacy Policy
              </a>
            )}
