...
/** A shared card link (`?card=<id>`) gets a per-card preview: the source's
 * name and a subtitle, rendered as a dynamic OpenGraph image so the unfurled
 * card reflects exactly what was shared. */
export async function generateMetadata({
  ...
  try {
    ...
    const subtitle = getTranslations().news.share.ogSubtitle
