...
export const WALL_THEMES: readonly WallTheme[] = [
  {
    id: 'ruby',
    label: 'Ruby',
    chrome: { light: '#f0eee6', dark: '#1a0407' },
  },
...
/** First-visit default edition: Ruby — the brand's favicon red. Warm ivory paper on
 * light systems, the App Store hero's red glow on dark (the tone follows the
 * OS; a stored choice always wins). */
export const DEFAULT_WALL_THEME_ID = 'ruby'
