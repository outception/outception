      ...
      return (
        <button
          ...
          className={
            ...
            'swatch relative h-[22px] w-[22px] shrink-0 cursor-pointer ' +
            'rounded-full border-2 sm:h-6 sm:w-6 ' +
    ...
    <>
      ...
      {column && (
        <button
          ...
          tabIndex={open ? 0 : -1}
          // The middle of the fan, between the light faces and the dark
          // ones. The swatches change how the wall LOOKS; this changes what
          // it shows, so it sits at the hinge rather than pretending to be
          // another edition at the end of a row.
          data-open={open}
          className="swatch swatch-centre absolute inset-0 flex cursor-pointer items-center justify-center rounded-full border-2 border-black/25 dark:border-white/25"
        >
          <svg
            viewBox="0 0 16 16"
            aria-hidden="true"
