...
const LandingHeader = () => {
  ...
  return (
    <Box
      ...
      // Flush with the top of the screen in both views, so the bar reads as
      // hanging off the edge rather than floating a little below it. The card
      // view keeps the space UNDER it, which the mosaic does not want: there
      // the header is out of the flow, and a transparent strip across the top
      // would swallow taps meant for the tiles.
      paddingTop="none"
      paddingBottom={floating ? 'none' : 'm'}
    >
