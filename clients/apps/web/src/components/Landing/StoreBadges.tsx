...
export const StoreBadges = () => {
  ...
  return (
    <Box alignItems="center" columnGap="s" flexWrap="wrap" justifyContent="center">
      ...
      <button type="button" className="ghost-pill store-pill" onClick={onAppStore}>
        <AppleGlyph />
