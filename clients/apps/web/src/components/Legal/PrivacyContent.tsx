  ...
  <Box flexDirection="column" rowGap="2xl">
    ...
    <Section title="Cookies &amp; similar technologies">
      <P>
        ...
        for localization. Our analytics partners set their own cookies as
        described above. You can clear cookies and local storage in your browser
        at any time.
      </P>
    </Section>
    ...
    <Section title="Why we process your data (legal bases)">
      <Box as="ul" flexDirection="column" rowGap="s">
        <Bullet>
          <strong>Consent</strong> — for analytics and precise location.
        </Bullet>
        <Bullet>
    ...
    <Section title="Sharing your data">
      <P>
        ...
        the EU), Google (analytics), PostHog, and Sentry — each acting under
    ...
    <Section title="Retention">
      <P>
        ...
        Analytics partners retain data according to their own policies.
      </P>
    </Section>
