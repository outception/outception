...
/** The Terms of Service body — shared by the /terms route and the wall footer's
 * popup dialog. */
  ...
  <Box flexDirection="column" rowGap="2xl">
    ...
    <Section title="The service">
      <P>
        ...
        requires no account. The service is supported by advertising.
      </P>
    </Section>
    ...
    <Section title="Acceptable use">
      ...
      <Box as="ul" flexDirection="column" rowGap="s">
        <Bullet>
          use the service in a way that breaks any law or infringes someone
          else’s rights;
        </Bullet>
        <Bullet>
        ...
        <Bullet>
          ...
          content except through any API we expressly provide, subject to its
          terms;
        </Bullet>
        <Bullet>
    ...
    <Section title="Advertising">
      <P>
        Outception is free to read and supported by ads served through Google
        (AdMob on mobile, AdSense on the web). Ad content is controlled by the
        ad networks and their advertisers, not by us. How advertising data is
