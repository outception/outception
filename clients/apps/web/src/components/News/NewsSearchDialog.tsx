...
/** The "Cards" / ⌘K source palette: search the roster, narrow by topic, and
...
export const NewsSearchDialog = () => {
  ...
  // Starter card sets are the default view: a fresh visitor opening "Sources"
              ...
              <div className="rule-hairline flex items-center gap-3 px-3 py-1.5">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    // On the unfiltered view this empties the whole card set, so
