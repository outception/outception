...
const entryButton =
  'cursor-pointer rounded-xl px-3 py-1 [color:color-mix(in_srgb,var(--color-ink)_55%,transparent)] transition-[color,transform] duration-100 hover:[color:var(--color-ink)] active:scale-95 active:[color:var(--color-ink)] dark:[color:color-mix(in_srgb,var(--color-ink-night)_65%,transparent)] dark:hover:[color:var(--color-ink-night)] dark:active:[color:var(--color-ink-night)]'
