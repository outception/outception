  ...
  return (
    ...
    <div className="game-strip flex max-h-16 min-h-9 grow flex-col">
      <Box
        ...
        textAlign="center"
      >
        {/* Free space between the navbar and the card. The gem ornament used
          to sit here between two hairlines; the editions hang there now, out
          of the navbar's gear, so the mark and its rules would only crowd
          them. */}
        <Box flexGrow={1} />
