;(function () {
  ...
  function e(e, t, o) {
    ...
    function s() {
      for (
        var e, t = [!0, !1, !0, !1, !1, !0, !1, !0], s = x * (o - 1), r = 0;
        8 > r;
        r++
      ) {
        e = _ * r
      ...
      for (var e = 0; 4 > e; e++)
        for (var t = e * _, s = 4 * _ + t, r = !0 & e, n = 0; n < o; n++) {
          var l = n + 1,
            ...
            c = s + l
          r
            ? (P.push(m), P.push(g), P.push(a), P.push(a), P.push(g), P.push(c))
      ...
      for (var e = [0, 2, 4, 6], t = [1, 3, 5, 7], s = 0; 4 > s; s++)
        for (var r = _ * e[s], n = _ * t[s], l = 1 >= s, m = 0; m < o; m++) {
          var g = m * x,
            ...
            c = n + p
          l
            ? (P.push(h), P.push(y), P.push(a), P.push(a), P.push(y), P.push(c))
      ...
      for (
        ...
        for (var l = t[n] * _, m = s[n] * _, g = 0; g <= e; g++) {
          var p = l + o + g * x,
            ...
            c = m + (g == e ? _ - 1 : o + (g + 1) * x)
          r[n]
            ? (P.push(p), P.push(h), P.push(a), P.push(a), P.push(h), P.push(c))
    ...
    for (var k = 0, V = 0; V < A.length; V++)
      (S.setXYZ(k, A[V].x, A[V].y, A[V].z),
        w.setXYZ(k, E[V].x, E[V].y, E[V].z),
        k++)
  ...
  const u = (() => {
    ...
    return new (class {
      ...
      remove(e) {
        ...
        0 > t ||
          (this.ids.splice(t, 1), delete this.animations[e.id], (e = null))
      }
    })()
  })()
  class g {
  ...
  class p extends g {
    ...
    resize() {
      ...
      let a =
        e < this.camera.aspect
          ? this.stage.height / 2 / m(t / 2)
          : this.stage.width / this.camera.aspect / (2 * m(t / 2))
      ;((a *= 0.5),
        this.camera.position.set(a, a, a),
        this.camera.lookAt(this.scene.position),
        this.camera.updateProjectionMatrix())
      const o =
        e < this.camera.aspect ? (this.height / 100) * e : this.width / 100
    ...
    createLights() {
      ;((this.lights = {
        ...
        ambient: new THREE.AmbientLight(16777215, 0.69),
  ...
  class h {
    ...
    init() {
      ;((this.cubes = []),
        ...
        2 === this.size
          ...
          : 3 === this.size
            ? (this.scale = 1)
            : 3 < this.size && (this.scale = 3 / this.size),
    ...
    resize(e = !1) {
      ;(this.size !== this.sizeGenerated || e) &&
    ...
    generateModel() {
      ...
      const a = 1 / 3,
        ...
        s = new THREE.Mesh(
          new e(a, this.geometry.pieceCornerRadius, 3),
          o.clone(),
        ),
    ...
    updateColors(e) {
      ;('object' != typeof this.pieces && 'object' != typeof this.edges) ||
        (this.pieces.forEach((t) => t.userData.cube.material.color.setHex(e.P)),
        this.edges.forEach((t) => t.material.color.setHex(e[t.name])))
    }
    loadFromData(e) {
      ;((this.size = e.size),
        this.reset(),
  ...
  const y = {
    Power: {
      ...
      InOut: (e) => (
        (e = r(e || 1)),
        (a) =>
          0.5 > a ? s(2 * a, e) / 2 : (1 - o(s(2 * a - 1 - 1, e))) / 2 + 0.5
      ),
    },
    Sine: {
      In: () => (e) => 1 + n((i / 2) * e - i / 2),
  ...
  class b extends g {
    ...
    update(e) {
      ...
      ;((this.progress += (e / this.duration) * a),
        ...
        null !== this.values && this.updateFromTo(),
        null === this.yoyo
          ? 1 >= this.progress
            ? this.onUpdate(this)
            : ((this.progress = 1),
    ...
    updateYoyo() {
      ;((1 < this.progress || 0 > this.progress) &&
        ((this.value = this.progress = 1 < this.progress ? 1 : 0),
        (this.yoyo = !this.yoyo)),
        this.onUpdate(this))
    }
    updateFromTo() {
  ...
  class v {
    ...
    convertPosition(e) {
      return (
        (e.x = 2 * (e.x / this.element.offsetWidth) - 1),
        (e.y = -(2 * (e.y / this.element.offsetHeight) - 1)),
        e
      )
    }
  }
  ...
  class x {
    constructor(e) {
      ;((this.game = e),
        (this.flipConfig = 0),
        (this.flipEasings = [y.Power.Out(3), y.Sine.Out(), y.Back.Out(1.5)]),
      ...
      ;((this.group = new THREE.Object3D()),
        ...
        this.helper.rotation.set(0, i / 4, 0),
    ...
    initDraggable() {
      ;((this.draggable = new v(this.game.dom.game)),
        (this.draggable.onDragStart = (e) => {
          if (null === this.scramble && 1 !== this.state && 2 !== this.state) {
            ...
            ;(!1 !== t &&
              ...
              !1 !== t && !1 !== this.dragIntersect
                ? ((this.dragNormal = t.face.normal.round()),
                  (this.flipType = 'layer'),
            ...
            !1 === a ||
              ((this.dragCurrent = this.helper.worldToLocal(a.point)),
              (this.dragTotal = new THREE.Vector3()),
              (this.state = this.state === f ? 1 : this.state))
          }
        }),
        (this.draggable.onDragMove = (e) => {
          if (
            null === this.scramble &&
            this.state !== f &&
            (3 !== this.state || !1 !== this.gettingDrag)
          ) {
            ...
            if (!1 !== t) {
              ...
              if (
                ...
                if (
                  ...
                  ;((this.flipAxis = a.cross(this.dragNormal).negate()),
                    this.selectLayer(this.getLayer(!1)))
                } else {
                  const t =
                    'x' == this.dragDirection
                      ? 'y'
                      : 'y' == this.dragDirection &&
                          e.current.x > this.game.world.width / 2
                        ? 'z'
                        : 'x'
                  ;((this.flipAxis = new THREE.Vector3()),
                    (this.flipAxis[t] = 1 * ('x' == t ? -1 : 1)))
                }
                ;((this.flipAngle = 0), (this.state = 2))
              } else if (2 === this.state) {
                const e = this.dragDelta[this.dragDirection]
                'layer' === this.flipType
                  ? (this.group.rotateOnAxis(this.flipAxis, e),
                    (this.flipAngle += e))
                  : (this.edges.rotateOnWorldAxis(this.flipAxis, e),
        ...
        (this.draggable.onDragEnd = () => {
          if (null === this.scramble) {
            if (2 !== this.state)
              return ((this.gettingDrag = !1), void (this.state = f))
            this.state = 3
            const e = this.getMomentum()[this.dragDirection],
              t = 0.05 < o(e) && o(this.flipAngle) < i / 2,
              s = t
                ? this.roundAngle(this.flipAngle + a(this.flipAngle) * (i / 4))
                : this.roundAngle(this.flipAngle),
              r = s - this.flipAngle
            'layer' === this.flipType
              ? this.rotateLayer(r, !1, () => {
                  ;(this.game.storage.saveGame(),
                    (this.state = this.gettingDrag ? 1 : f),
                    (this.gettingDrag = !1),
                    this.checkIsSolved())
                })
              : this.rotateCube(r, () => {
    ...
    bounceCube() {
      ...
      return (t, a, o) => {
        1 <= t &&
          (e && ((a = (t - 1) * o), (e = !1)),
          this.game.cube.object.rotateOnAxis(this.flipAxis, a))
      }
    }
    rotateCube(e, t) {
      ...
      this.rotationTween = new b({
        ...
        duration: s,
        onUpdate: (t) => {
          ;(this.edges.rotateOnWorldAxis(this.flipAxis, t.delta * e),
            this.game.cube.object.rotation.copy(this.edges.rotation))
        },
        onComplete: () => {
    ...
    selectLayer(e) {
      ;(this.group.rotation.set(0, 0, 0),
        this.movePieces(e, this.game.cube.object, this.group),
        (this.flipLayer = e))
    }
    deselectLayer(e) {
      ;(this.movePieces(e, this.group, this.game.cube.object),
        (this.flipLayer = null))
    }
    movePieces(e, t, a) {
      ;(t.updateMatrixWorld(),
        ...
        e.forEach((e) => {
          ...
          ;(o.applyMatrix(t.matrixWorld),
            t.remove(o),
            o.applyMatrix(new THREE.Matrix4().getInverse(a.matrixWorld)),
            a.add(o))
        }))
    }
    getLayer(e) {
      const t = { 2: 6, 3: 3, 4: 4, 5: 3 }[this.game.cube.size],
        a = []
      let o
      if (!1 === e) {
        const a = this.dragIntersect.object.parent
        ;((o = this.getMainAxis(this.flipAxis)),
          (e = a.position.clone().multiplyScalar(t).round()))
      } else o = this.getMainAxis(e)
      return (
        this.game.cube.pieces.forEach((s) => {
    ...
    keyboardMove(e, t) {
      if (this.state === f && !0 === this.enabled)
        if ('LAYER' === e) {
          ...
          ;((this.flipAxis = new THREE.Vector3()),
            (this.flipAxis[t.axis] = 1),
            (this.state = 2),
            this.selectLayer(e),
            this.rotateLayer(t.angle, !1, () => {
              ;(this.game.storage.saveGame(),
                (this.state = f),
                this.checkIsSolved())
            }))
    ...
    scrambleCube() {
      ...
      ;((this.flipAxis = new THREE.Vector3()),
        (this.flipAxis[t.axis] = 1),
        this.selectLayer(a),
        this.rotateLayer(t.angle, !0, () => {
          ;(e.shift(),
            0 < e.length
              ? this.scrambleCube()
              : ((this.scramble = null), this.game.storage.saveGame()))
        }))
    }
    getIntersect(e, t, a) {
      this.raycaster.setFromCamera(
        this.draggable.convertPosition(e.clone()),
        this.game.world.camera,
      )
      const o = a
        ? this.raycaster.intersectObjects(t)
        : this.raycaster.intersectObject(t)
    ...
    attach(e, t) {
      ;(e.applyMatrix(new THREE.Matrix4().getInverse(t.matrixWorld)),
        this.game.world.scene.remove(e),
        t.add(e))
    }
    addMomentumPoint(e) {
      const t = Date.now()
      ;((this.momentum = this.momentum.filter((e) => 500 > t - e.time)),
        !1 !== e && this.momentum.push({ delta: e, time: t }))
    }
    getMomentum() {
  ...
  class z {
    ...
    scramble(e) {
      let t = 0
      if (
        ((this.moves = 'undefined' == typeof e ? [] : e.split(' ')),
        1 > this.moves.length)
      ) {
        ...
        for (; t < r; ) {
          ...
          ;(0 < t && e.charAt(0) == this.moves[t - 1].charAt(0)) ||
            (1 < t && e.charAt(0) == this.moves[t - 2].charAt(0)) ||
            (this.moves.push(e), t++)
        }
      }
      return (
  ...
  class S {
    constructor(e) {
      ;((this.game = e),
        (this.tweens = {}),
        (this.durations = {}),
        (this.data = { cubeY: -0.2, cameraZoom: 0.85 }),
    ...
    init() {
      ;(this.game.controls.disable(),
        ...
        (this.game.cube.animator.rotation.x = -i / 3),
    ...
    buttons(e, t) {
      ...
      ;(t.forEach(
        (e) => (this.tweens.buttons[e] = a(this.game.dom.buttons[e], !1)),
      ),
        setTimeout(
          () =>
            e.forEach((e) => {
    ...
    cube(e, t = !1) {
      ...
      ;((this.tweens.cube = new b({
        duration: e ? 3e3 : 1250,
        easing: e ? y.Elastic.Out(0.8, 0.6) : y.Back.In(1),
        onUpdate: (s) => {
          ;((this.game.cube.animator.position.y = e
            ? t
              ? 0.9 + 3.5 * (1 - s.value)
              : 4 * (1 - s.value)
            : a + 4 * s.value),
            (this.game.cube.animator.rotation.x = e
              ? ((1 - s.value) * i) / 3
              : o + (s.value * -i) / 3))
        },
      })),
        ...
        (this.durations.cube = e ? 1500 : 1500),
    ...
    float() {
      ...
      this.tweens.float = new b({
        ...
        yoyo: !0,
        onUpdate: (e) => {
          ;((this.game.cube.holder.position.y = -0.02 + 0.04 * e.value),
            (this.game.cube.holder.rotation.x = 0.005 - 0.01 * e.value),
    ...
    complete(e, t) {
      ...
      null === a.querySelector('span i') &&
        a.querySelectorAll('span').forEach((e) => this.splitLetters(e))
      ...
      ;(e ||
        setTimeout(() => (this.game.dom.texts.timer.style.transform = ''), s),
        setTimeout(() => this.activeTransitions--, s))
    }
    stats(e) {
      ;(e && this.game.scores.calcStats(),
        this.activeTransitions++,
        this.tweens.stats.forEach((e) => {
          ;(e.stop(), (e = null))
        }))
      let t = -1
      ...
      ;(a.forEach((a, s) => {
        ...
        this.tweens.stats[t++] = new b({
          ...
          onUpdate: (t) => {
            ...
            ;((a.style.transform = `translate3d(0, ${o}em, 0)`),
              (a.style.opacity = s))
          },
        })
      }),
    ...
    ranges(e, t, a) {
      ...
      ;(e.forEach((e, n) => {
        ...
        ;((i.style.opacity = a ? 0 : 1),
          (l.style.opacity = a ? 0 : 1),
          (c.style.opacity = a ? 0 : 1),
          (c.style.pointerEvents = a ? 'all' : 'none'),
          (this.tweens[t][s++] = new b({
            ...
            onUpdate: (e) => {
              ...
              ;((i.style.transform = `translate3d(0, ${t}em, 0)`),
                (i.style.opacity = o))
            },
          })),
          (this.tweens[t][s++] = new b({
            ...
            onUpdate: (e) => {
              const t = a ? 1 - e.value : e.value,
                o = a ? e.value : 1 - e.value
              ;((l.style.transform = `translate3d(0, ${t}em, 0) scale3d(${o}, 1, 1)`),
                (l.style.opacity = o))
            },
          })),
          (this.tweens[t][s++] = new b({
            ...
            onUpdate: (e) => {
              const t = a ? 1 - e.value : e.value,
                o = 1 - t,
                s = 0.5 + 0.5 * o
              ;((c.style.transform = `translate3d(0, ${t}em, 0) scale3d(${s}, ${s}, ${s})`),
                (c.style.opacity = o))
            },
          })),
          m.forEach((e, r) => {
            ;((e.style.opacity = a ? 0 : 1),
              (this.tweens[t][s++] = new b({
                ...
                onUpdate: (t) => {
                  ...
                  ;((e.style.transform = `translate3d(0, ${o}em, 0)`),
                    (e.style.opacity = s))
                },
              })))
          }),
          (r = m.length > r ? m.length - 1 : r),
          (e.style.opacity = 1))
      }),
        (this.durations[t] = a
          ? 100 * (e.length - 1) + 200 + 50 * r + 400
          : 100 * (e.length - 1) + 400),
    ...
    title(e) {
      ...
      null === t.querySelector('span i') &&
        t.querySelectorAll('span').forEach((e) => this.splitLetters(e))
      ...
      ;((this.tweens.title[a.length] = new b({
        ...
        duration: e ? 800 : 400,
        yoyo: !!e || null,
        from: { opacity: e ? 0 : parseFloat(getComputedStyle(o).opacity) },
        to: { opacity: e ? 1 : 0 },
      })),
    ...
    flipLetters(e, t, a) {
      ...
      ;(t.forEach((t, o) => {
        ;((t.style.opacity = a ? 0 : 1),
          (this.tweens[e][o] = new b({
            easing: y.Sine.Out(),
            duration: a ? 800 : 400,
            delay: 50 * o,
            onUpdate: (e) => {
              const o = a ? -80 * (1 - e.value) : 80 * e.value
              ;((t.style.transform = `rotate3d(0, 1, 0, ${o}deg)`),
                (t.style.opacity = a ? e.value : 1 - e.value))
            },
          })))
      }),
  ...
  class w extends g {
    ...
    start(e) {
      ;((this.startTime = e ? Date.now() - this.deltaTime : Date.now()),
        (this.deltaTime = 0),
    ...
    stop() {
      return (
        ...
        this.convert(),
        super.stop(),
        { time: this.converted, millis: this.deltaTime }
      )
    }
    update() {
  ...
  document.querySelectorAll('range').forEach((e) => {
    ...
    ;(a.setAttribute('name', e.getAttribute('name')),
      (o.innerHTML = e.getAttribute('title')),
      e.hasAttribute('color') &&
        (a.classList.add('range--type-color'),
        a.classList.add('range--color-' + e.getAttribute('name'))),
      e.hasAttribute('list') &&
        e
          .getAttribute('list')
          .split(',')
  ...
  class C {
    constructor(e, t) {
      ;((t = Object.assign(
        ...
        (this.element = document.querySelector('.range[name="' + e + '"]')),
    ...
    initDraggable() {
      let e
      ;((this.draggable = new v(this.handle, { calcDelta: !0 })),
        (this.draggable.onDragStart = () => {
          ;((e = this.positionFromValue(this.value)),
            (this.handle.style.left = e + 'px'))
        }),
        (this.draggable.onDragMove = (t) => {
          ;((e = this.limitPosition(e + t.delta.x)),
            (this.value = this.round(this.valueFromPosition(e))),
    ...
    round(e) {
      return 1 > this.step
        ? e
        : r((e - this.min) / this.step) * this.step + this.min
    }
    limitValue(e) {
    ...
    init() {
      ;((this.ranges = {
        size: new C('size', {
          ...
          step: 1,
          onUpdate: (e) => {
            ;((this.game.cube.size = e),
              this.game.preferences.ranges.scramble.list.forEach((e, t) => {
                e.innerHTML =
                  this.game.scrambler.scrambleLength[this.game.cube.size][t]
              }))
          },
  ...
  class T {
    constructor(e) {
      ;((this.game = e),
        ...
        (this.holders = [
          new M(this.game, this, 1, 20),
          new M(this.game, this, -1, 30),
        ]))
    }
    start() {
      0 < this.started ||
  ...
  class M extends g {
    ...
    update() {
      const e = performance.now(),
        t = e - this.time
      this.time = e
      for (let e = this.count; e--; )
        this.particles[e].completed || this.particles[e].update(t)
  ...
  class A {
    ...
    reset(e = !0) {
      ;((this.completed = !1),
        (this.color = new THREE.Color(
          this.options.colors[d(Math.random() * this.options.colors.length)],
        )),
        this.mesh.material.color.set(this.color),
        (this.speed =
          -1 *
          THREE.Math.randFloat(this.options.speed.min, this.options.speed.max)),
        (this.mesh.position.x = THREE.Math.randFloat(
          -this.confetti.width / 2,
          this.confetti.width / 2,
        )),
        (this.mesh.position.y = e
        ...
        (this.revolutionAxis = ['x', 'y', 'z'][d(3 * Math.random())]),
    ...
    update(e) {
      ;((this.mesh.position.y += this.speed * e),
        (this.mesh.rotation[this.revolutionAxis] += this.revolutionSpeed),
        this.mesh.position.y < -this.confetti.height - this.size &&
          (this.confetti.playing ? this.reset(!1) : this.stop()))
    }
  }
  class E {
    constructor(e) {
    ...
    addScore(e) {
      ...
      let a = !1
      return (
        (e < t.best || 0 === t.best) && ((t.best = e), (a = !0)),
        e > t.worst && (t.worst = e),
    ...
    calcStats() {
      const e = this.game.cube.sizeGenerated,
        t = this.data[e]
      ;(this.setStat('cube-size', `${e}<i>x</i>${e}<i>x</i>${e}`),
        this.setStat('total-solves', t.solves),
        this.setStat('best-time', this.convertTime(t.best)),
        this.setStat('worst-time', this.convertTime(t.worst)),
    ...
    setStat(e, t) {
      ;(0 === t && (t = '-'),
        (this.game.dom.stats.querySelector(`.stats[name="${e}"] b`).innerHTML =
          t))
    }
    getAverage(e) {
      const t = this.data[this.game.cube.sizeGenerated]
      return t.scores.length < e
        ? 0
        : this.convertTime(t.scores.slice(-e).reduce((e, t) => e + t, 0) / e)
    }
    convertTime(e) {
      if (0 >= e) return 0
  ...
  class P {
    ...
    saveGame() {
      const e = { names: [], positions: [], rotations: [] },
        t = this.game.timer.deltaTime
      ;((e.size = this.game.cube.sizeGenerated),
        this.game.cube.pieces.forEach((t) => {
          ;(e.names.push(t.name),
            e.positions.push(t.position),
            e.rotations.push(t.rotation.toVector3()))
        }),
        localStorage.setItem('theCube_playing', !0),
        localStorage.setItem('theCube_savedState', JSON.stringify(e)),
        localStorage.setItem('theCube_time', t))
    }
    clearGame() {
    ...
    migrateScores() {
      try {
        ...
        if (!e || !t || !o || !a) return !1
        ;((this.game.scores.data[3].scores = e),
          (this.game.scores.data[3].best = t),
          (this.game.scores.data[3].solves = o),
          (this.game.scores.data[3].worst = a),
    ...
    loadPreferences() {
      try {
        ...
        if (!e) throw new Error()
        return (
          (this.game.cube.size = parseInt(e.cubeSize)),
          (this.game.controls.flipConfig = parseInt(e.flipConfig)),
          (this.game.scrambler.dificulty = parseInt(e.dificulty)),
          (this.game.world.fov = parseFloat(e.fov)),
          this.game.world.resize(),
          (this.game.themes.colors = e.colors),
          this.game.themes.setTheme(e.theme),
          !0
        )
      } catch (t) {
        return (
  ...
  class _ {
    ...
    colorFromHSL(e, t, a) {
      return (
        ...
        (t = r(t)),
        (a = r(a)),
        new THREE.Color(`hsl(${e}, ${t}%, ${a}%)`)
      )
    }
    setHSL(e = null, t = !1) {
      this.editColor = null === e ? 'R' : e
      const a = new THREE.Color(this.game.themes.getColors()[this.editColor]),
        { h: o, s: r, l: s } = a.getHSL(a),
        { hue: n, saturation: i, lightness: l } = this.game.preferences.ranges
      if (t) {
        const e = n.value / 360,
          t = i.value / 100,
          c = l.value / 100,
          m = this.colorFromHSL(n.value, i.value, l.value)
        ;(this.tweenHSL && this.tweenHSL.stop(),
          (this.tweenHSL = new b({
            duration: 200,
            easing: y.Sine.Out(),
            onUpdate: (d) => {
              ;(n.setValue(360 * (e + (o - e) * d.value)),
                i.setValue(100 * (t + (r - t) * d.value)),
                l.setValue(100 * (c + (s - c) * d.value)))
              const u = m.clone().lerp(a, d.value),
                g = u.getStyle(),
                p = u.getHSL(u)
              ;((n.handle.style.color = g),
                (i.handle.style.color = g),
                (l.handle.style.color = g),
                (i.track.style.color = this.colorFromHSL(
                  360 * p.h,
                  100,
                  50,
                ).getStyle()),
                (l.track.style.color = this.colorFromHSL(
                  360 * p.h,
                  100 * p.s,
                  50,
                ).getStyle()),
    ...
    updateHSL() {
      const {
        ...
        r = t.value,
        s = a.value,
        n = this.colorFromHSL(o, r, s).getStyle()
      ;((e.handle.style.color = n),
        (t.handle.style.color = n),
        (a.handle.style.color = n),
        (t.track.style.color = this.colorFromHSL(o, 100, 50).getStyle()),
        (a.track.style.color = this.colorFromHSL(o, r, 50).getStyle()),
        (this.game.dom.theme.style.display = 'none'),
        this.game.dom.theme.offsetHeight,
        (this.game.dom.theme.style.display = ''))
      const i = this.game.themes.theme
      ;((this.game.themes.colors[i][this.editColor] = this.colorFromHSL(
        o,
        r,
        s,
      ).getHex()),
    ...
    colorPicker(e) {
      e
        ? this.game.dom.game.addEventListener('click', this.getPieceColor, !1)
  ...
  const V = new (class {
      constructor(e) {
        if (
          ...
          e.convert && this.convertAllIcons(),
          e.observe)
        ) {
      ...
      addStyles() {
        ...
        ;((e.innerHTML = `.${this.className} { display: inline-block; font-size: inherit; overflow: visible; vertical-align: -0.125em; preserveAspectRatio: none; }`),
    ...
    I = { Menu: 0, Playing: 1, Complete: 2, Stats: 3, Prefs: 4, Theme: 5 },
    H = {
      Menu: ['stats', 'prefs'],
      Playing: ['back'],
      Complete: [],
  ...
  window.game = new (class {
    constructor() {
      ;((this.dom = {
        ...
        (this.world = new p(this)),
        (this.cube = new h(this)),
        (this.controls = new x(this)),
        (this.scrambler = new z(this)),
        (this.transition = new S(this)),
        (this.timer = new w(this)),
        (this.preferences = new L(this)),
        (this.scores = new E(this)),
        (this.storage = new P(this)),
        (this.confetti = new T(this)),
        (this.themes = new D(this)),
        (this.themeEditor = new _(this)),
        this.initActions(),
        (this.state = I.Menu),
        (this.newGame = !1),
        (this.saved = !1),
        ...
        setTimeout(() => {
          ;(this.transition.float(),
            this.transition.cube(!0),
            setTimeout(() => this.transition.title(!0), 700),
            setTimeout(() => this.transition.buttons(H.Menu, H.None), 1e3))
        }, 500))
    }
    initActions() {
      let e = !1
      ;(this.dom.game.addEventListener(
        ...
        () => {
          if (
            !(0 < this.transition.activeTransitions) &&
            ...
            if (this.state === I.Menu) {
              ...
              this.state === I.Complete
                ? this.complete(!1)
                : this.state === I.Stats && this.stats(!1)
        },
        !1,
      ),
        ...
        (this.dom.buttons.back.onclick = () => {
          0 < this.transition.activeTransitions ||
            (this.state === I.Playing
              ...
              : this.state === I.Prefs
                ? this.prefs(!1)
                : this.state === I.Theme && this.theme(!1))
        }),
        (this.dom.buttons.reset.onclick = () => {
          this.state === I.Theme && this.themeEditor.resetTheme()
        }),
        (this.dom.buttons.prefs.onclick = () => this.prefs(!0)),
        (this.dom.buttons.theme.onclick = () => this.theme(!0)),
        (this.dom.buttons.stats.onclick = () => this.stats(!0)),
        (this.controls.onSolved = () => this.complete(!0)))
    }
    game(e) {
      if (e) {
        this.saved ||
        ...
        ;((this.state = I.Playing),
          (this.saved = !0),
          this.transition.buttons(H.None, H.Menu),
          this.transition.zoom(I.Playing, e),
          this.transition.title(!1),
          setTimeout(() => {
            ;(this.transition.timer(!0),
              this.transition.buttons(H.Playing, H.None))
          }, this.transition.durations.zoom - 1e3),
          setTimeout(() => {
            ;(this.controls.enable(), this.newGame || this.timer.start(!0))
          }, this.transition.durations.zoom))
      } else
        ((this.state = I.Menu),
          this.transition.buttons(H.Menu, H.Playing),
          this.transition.zoom(I.Menu, 0),
          this.controls.disable(),
          this.newGame || this.timer.stop(),
          this.transition.timer(!1),
          setTimeout(
            () => this.transition.title(!0),
            this.transition.durations.zoom - 1e3,
          ),
          (this.playing = !1),
          this.controls.disable())
    ...
    prefs(e) {
      if (e) {
        ...
        ;((this.state = I.Prefs),
          this.transition.buttons(H.Prefs, H.Menu),
          this.transition.title(!1),
          this.transition.cube(!1),
          setTimeout(() => this.transition.preferences(!0), 1e3))
      } else
        (this.cube.resize(),
          (this.state = I.Menu),
          this.transition.buttons(H.Menu, H.Prefs),
          this.transition.preferences(!1),
          setTimeout(() => this.transition.cube(!0), 500),
          setTimeout(() => this.transition.title(!0), 1200))
    }
    theme(e) {
      if ((this.themeEditor.colorPicker(e), e)) {
        if (0 < this.transition.activeTransitions) return
        ;(this.cube.loadFromData(k[3].checkerboard),
          this.themeEditor.setHSL(null, !1),
          (this.state = I.Theme),
          this.transition.buttons(H.Theme, H.Prefs),
          this.transition.preferences(!1),
          setTimeout(() => this.transition.cube(!0, !0), 500),
          setTimeout(() => this.transition.theming(!0), 1e3))
      } else
        ((this.state = I.Prefs),
          this.transition.buttons(H.Prefs, H.Theme),
          this.transition.cube(!1, !0),
          this.transition.theming(!1),
          setTimeout(() => this.transition.preferences(!0), 1e3),
          setTimeout(() => {
            const e = JSON.parse(localStorage.getItem('theCube_savedState'))
            return e
              ? void this.cube.loadFromData(e)
              : void this.cube.resize(!0)
          }, 1500))
    }
    stats(e) {
      if (e) {
        if (0 < this.transition.activeTransitions) return
        ;((this.state = I.Stats),
          this.transition.buttons(H.Stats, H.Menu),
          this.transition.title(!1),
          this.transition.cube(!1),
          setTimeout(() => this.transition.stats(!0), 1e3))
      } else
        ((this.state = I.Menu),
          this.transition.buttons(H.Menu, H.None),
          this.transition.stats(!1),
          setTimeout(() => this.transition.cube(!0), 500),
          setTimeout(() => this.transition.title(!0), 1200))
    }
    complete(e) {
      return e
        ? void (this.transition.buttons(H.Complete, H.Playing),
          (this.state = I.Complete),
          (this.saved = !1),
          this.controls.disable(),
          this.timer.stop(),
          ...
          setTimeout(() => {
            ;(this.transition.complete(!0, this.bestTime),
              this.confetti.start())
          }, 1e3))
        : ((this.state = I.Stats),
          (this.saved = !1),
          this.transition.timer(!1),
          this.transition.complete(!1, this.bestTime),
          this.transition.cube(!1),
          this.timer.reset(),
          setTimeout(() => {
            ;(this.cube.reset(),
              this.confetti.stop(),
              this.transition.stats(!0),
              this.transition.elevate(0))
          }, 1e3),
          !1)
    }
