...
const S3_PUBLIC_IMAGES_BUCKET_ORIGIN = process.env
  ...
  : ''
// AdSense ad serving + the Google-certified consent message (Privacy &
// messaging / Funding Choices) that GDPR requires for EEA/UK ad traffic.
const ADSENSE_SCRIPT_ORIGINS =
  'https://pagead2.googlesyndication.com https://tpc.googlesyndication.com https://googleads.g.doubleclick.net https://fundingchoicesmessages.google.com https://ep2.adtrafficquality.google https://adservice.google.com https://www.googletagservices.com'
const ADSENSE_FRAME_ORIGINS =
  'https://googleads.g.doubleclick.net https://tpc.googlesyndication.com https://www.google.com https://fundingchoicesmessages.google.com https://ep2.adtrafficquality.google'
// stats./td.doubleclick.net carry GA4's Google Signals + remarketing traffic,
// which only starts once the reader grants ad_storage.
const ADSENSE_CONNECT_ORIGINS =
  'https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://fundingchoicesmessages.google.com https://ep1.adtrafficquality.google https://csi.gstatic.com https://stats.g.doubleclick.net https://td.doubleclick.net'
const ADSENSE_IMG_ORIGINS =
  'https://pagead2.googlesyndication.com https://tpc.googlesyndication.com https://googleads.g.doubleclick.net https://ep1.adtrafficquality.google https://www.google.com'
const baseCSP = `
    default-src 'self';
    connect-src 'self' ${process.env.NEXT_PUBLIC_API_URL} ${process.env.S3_UPLOAD_ORIGINS} https://maps.googleapis.com https://*.google-analytics.com ${ADSENSE_CONNECT_ORIGINS};
    frame-src 'self' ${ADSENSE_FRAME_ORIGINS};
    script-src 'self' ${ENVIRONMENT === 'development' ? "'unsafe-eval'" : ''} 'unsafe-inline' https://maps.googleapis.com https://www.googletagmanager.com ${ADSENSE_SCRIPT_ORIGINS};
    style-src 'self' 'unsafe-inline' https://fonts.googleapis.com;
    img-src 'self' blob: data: https://www.gravatar.com https://img.logo.dev https://lh3.googleusercontent.com https://avatars.githubusercontent.com ${S3_PUBLIC_IMAGES_BUCKET_ORIGIN} https://uploads.outception.com https://upload.wikimedia.org https://commons.wikimedia.org https://cdn.jsdelivr.net https://flagcdn.com https://icons.duckduckgo.com ${ADSENSE_IMG_ORIGINS};
    font-src 'self';
    object-src 'none';
    base-uri 'self';
