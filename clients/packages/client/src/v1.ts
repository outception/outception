...
export interface paths {
  ...
  '/v1/news/sources': {
    ...
    /**
     * List Sources
     * @description Metadata for every known source (including redirect aliases). Pass
  ...
  '/v1/news/sources/{source_id}': {
    ...
    /**
     * Get Source Meta
     * @description Metadata for one source - what a share-card unfurl needs, without
     *     pulling the whole roster.
     */
    get: operations['news:get_source_meta']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/v1/news/default-deck': {
     ...
     * Default Cards
     * @deprecated
     * @description The default "Your stack" seeded for a fresh visitor: one representative
  ...
  '/v1/news/default-cards': {
     ...
     *     USA → NFL/NBA/MLB). Retired sources are dropped.
     */
    get: operations['news:default_cards']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/v1/news/summary/available': {
     ...
     * @description Cheap pre-check for a headline tap: known-unavailable articles (videos,
     ...
     */
    get: operations['news:get_summary_availability']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/v1/news/summary/stream': {
    ...
    /**
     * Stream Article Summary
     * @description The AI summary as server-sent events, so the panel shows the text as it
     ...
     */
    get: operations['news:stream_article_summary']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/v1/news/summary': {
    ...
    /**
     * Get Article Summary
     * @description AI summary for a headline tap. One model call per article+language -
     *     everything else is served from cache (and the edge can cache it too).
     */
    get: operations['news:get_article_summary']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/v1/news/crossword': {
    ...
    /**
     * Get Crossword
     * @description The daily crossword for the wall's puzzle card. One upstream fetch per
     *     day (Redis-cached); every reader worldwide gets the same puzzle, so the
     *     payload is fully cacheable at the edge.
     */
    get: operations['news:get_crossword']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/v1/news/heatmap/{heatmap_id}': {
    ...
    /**
     * Get Heatmap
     * @description Tiles for one market heatmap card (a `type: "heatmap"` roster source).
     *
     ...
     *     sources.
     */
    get: operations['news:get_heatmap']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/v1/news/translate': {
    ...
    /**
     * Translate Headlines
     * @description Translations the wall has already made, for a batch of headlines.
  ...
  '/v1/promoted/active': {
    ...
    /**
     * Get Active Slot
     * @description The Promoted card currently running, if any. At most one slot is ever
     ...
     */
    get: operations['promoted:get_active_slot']
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface components {
  schemas: {
    ...
    /**
     * CrosswordResponse
     * @description The daily syndicated crossword, parsed for the wall's puzzle card:
    ...
    CrosswordResponse: {
      ...
      grid: string[]
      /** Across */
      across: components['schemas']['CrosswordClue'][]
      /** Down */
      down: components['schemas']['CrosswordClue'][]
    }
    /** EmailOTPRequest */
    EmailOTPRequest: {
      /**
    ...
    /**
     * HeatmapTile
     * @description One treemap tile: area from ``weight`` (market cap), color from
     *     ``changePercent``.
     */
    HeatmapTile: {
      /** Symbol */
    ...
    /**
     * NewsTemplate
     * @description A starter template: a persona's curated source bundle, country-resolved.
    ...
    SourceMeta: {
      ...
      column?: string | null
      /** Type */
      type?: ('hottest' | 'realtime' | 'heatmap' | 'game') | null
      /** Home */
      home?: string | null
      /** Title */
      title?: string | null
    ...
    /**
     * SummaryAvailability
     * @description Whether a headline tap can expect an AI summary, decided from what the
    ...
    /**
     * SummaryResponse
     * @description AI summary for a headline tap: the model-written text plus the
     *     article URL it covers (the client links to it under the summary).
     */
    SummaryResponse: {
      /**
       * Summary
       * @description Model-written summary of the article
       */
      summary: string
      /**
       * Url
       * @description The article URL the summary covers
       */
      url: string
      /**
       * Kind
       * @description 'summary' is model-written from the article; 'teaser' is the publisher's own standfirst, shown when the article itself is not available (paywall, bot wall)
       * @default summary
       * @enum {string}
       */
      kind: 'summary' | 'teaser'
    ...
    TemplatesResponse: {
      /** Templates */
      templates: components['schemas']['NewsTemplate'][]
    }
    /** TokenResponse */
    TokenResponse: {
      /** Access Token */
...
export interface operations {
  ...
  'news:get_summary_availability': {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['SummaryAvailability']
        }
      }
      /** @description Validation Error */
      422: {
  ...
  'news:get_article_summary': {
    ...
    responses: {
      ...
      /** @description Summary unavailable for this article */
      502: {
        headers: {
          [name: string]: unknown
        }
      ...
      /** @description Summaries not configured */
      503: {
        headers: {
          [name: string]: unknown
        }
  ...
  'news:get_crossword': {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['CrosswordResponse']
        }
      }
    }
  }
  ...
  'promoted:get_active_slot': {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          'application/json': components['schemas']['PromotedSlot'] | null
        }
      }
    }
  }
...
export const heatmapResponseStatusValues: ReadonlyArray<
  FlattenedDeepRequired<components>['schemas']['HeatmapResponse']['status']
> = ['success', 'cache']
...
> = ['user', 'organization']
export const summaryResponseKindValues: ReadonlyArray<
  FlattenedDeepRequired<components>['schemas']['SummaryResponse']['kind']
> = ['summary', 'teaser']
