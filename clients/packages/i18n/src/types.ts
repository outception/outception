...
// which remain atomic (all-or-nothing). This lets non-English locale files lag
// behind en.ts without breaking type checking - the CI translation job fills
// the gaps on every PR, and at runtime missing keys fall back to English via
// getTranslations' deep merge.
