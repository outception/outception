...
export const backgroundColors = stylex.defineVars({
  'background-primary': `light-dark(${palette.white}, ${palette.outception950})`,
  'background-secondary': `light-dark(${palette.gray50}, ${palette.outception900})`,
  'background-card': `light-dark(${palette.gray100}, ${palette.outception800})`,
...
export const textColors = stylex.defineVars({
  ...
  'text-secondary': `light-dark(${palette.gray500}, ${palette.outception400})`,
  'text-tertiary': `light-dark(${palette.gray400}, ${palette.outception500})`,
  'text-disabled': `light-dark(${palette.gray300}, ${palette.outception600})`,
...
export const borderColors = stylex.defineVars({
  'border-primary': `light-dark(${palette.gray200}, ${palette.outception700})`,
  'border-secondary': `light-dark(${palette.gray100}, ${palette.outception800})`,
