...
//
// The neutral ramps (`gray*` light, `outception*` dark) are the canonical
...
export const palette = stylex.defineVars({
  ...
  // Dark-mode neutrals (the Outception dark ramp).
  outception50: 'hsl(233, 4%, 85%)',
  outception100: 'hsl(233, 4%, 79%)',
  outception200: 'hsl(233, 4%, 68%)',
  outception300: 'hsl(233, 4%, 62%)',
  outception400: 'hsl(233, 4%, 52%)',
  outception500: 'hsl(233, 4%, 46%)',
  outception600: 'hsl(233, 4%, 22%)',
  outception700: 'hsl(233, 4%, 13%)',
  outception800: 'hsl(233, 4%, 9.5%)',
  outception900: 'hsl(233, 4%, 6.5%)',
  outception950: 'hsl(233, 4%, 3.5%)',
...
export const fontFamilies = stylex.defineVars({
  ...
  display: "'Hanken Grotesk', 'InterDisplay', sans-serif",
