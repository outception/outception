...
- `apps/web`: [outception.com](https://outception.com) – [Next.js](https://nextjs.org/) app
...
- `packages/orbit`: Outception's design system containing components and design tokens
