...
Build your own set of cards. Every card is a publisher you picked. Add the ones
you want, drop the ones you do not, and the wall is yours.

There is no account and nothing to sign up for. Open it and read.

## What it is

Headlines from more than 10,000 sources, laid out as cards by topic. News,
world, sports, finance, science, entertainment, tech and social. Next to them
sit live tables: stock sectors, crypto, Steam charts, and league standings for
more than 20 competitions.

If you do not want to start from nothing, tap a ready made set. Developer,
Investor, Sports Fan and plenty more. The cards appear and you change them
whenever you like.

It stays free to read. The web wall is at
[outception.com](https://outception.com) and the iOS app is on the
[App Store](https://apps.apple.com/app/id6793827093).

## Features

- News cards on web and mobile, laid out by topic
...
- Starter templates: one-tap persona cards (Developer, Investor, Sports Fan, and more)
